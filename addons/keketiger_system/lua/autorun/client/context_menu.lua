...
hook.Add('OnContextMenuOpen', 'CustomContextMenuHookOpen', function()
    ...
    actionButton(ScrW() * 0.005, ScrH() * 0.075, ScrW() * 0.19, ScrH() * 0.025, Tiger.PrimaryButtonColor, 'Ecrire une lettre', 'TigerAS1_Context', function()
        validAction('Ecrire une lettre', function()
            LocalPlayer():ConCommand('say /write ' .. validFrameAction:GetText())
            frameActionValidBeforeStart:Close()
        end)
    end)
    ...
    actionButton(ScrW() * 0.005, ScrH() * 0.225, ScrW() * 0.19, ScrH() * 0.025, Tiger.AdminButtonColor, 'Faire un Ticket Admin', 'TigerAS1_Context', function()
        validAction('Ticket Admin', function()
            RunConsoleCommand('say', '@ ' .. validFrameAction:GetText())
            frameActionValidBeforeStart:Close()
        end)
    end)
